...
export default function ModalCreateAdvertising() {
  //modal
      ...
      <Modal open={open} onClose={handleOpenClose}>
        ...
        >
          <div
            ...
            className="bg-[#484848] rounded-tr-[30px] rounded-tl-[30px] h-[67px] flex justify-end items-center"
          >
            <svg
              className="mr-[15px]"
          ...
          <div className="flex justify-end m-5">
            <ButtonSave onClick={handleOpenClose} />
          </div>
        </div>
      </Modal>
    </>
